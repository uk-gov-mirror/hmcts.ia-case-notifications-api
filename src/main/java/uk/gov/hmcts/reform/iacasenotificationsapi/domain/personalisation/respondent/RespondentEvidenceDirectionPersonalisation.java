...
public class RespondentEvidenceDirectionPersonalisation implements EmailNotificationPersonalisation {
    ...
    public Map<String, String> getPersonalisation(AsylumCase asylumCase) {
        ...
        return ImmutableMap
            ...
            .put("companyName", hasNoc ? "" : asylumCase.read(LEGAL_REP_COMPANY_NAME, String.class).orElse(""))
            .put("companyAddress", hasNoc ? "" : companyAddress)
            .put("legalRepName", hasNoc ? "" : asylumCase.read(LEGAL_REPRESENTATIVE_NAME, String.class).orElse(""))
